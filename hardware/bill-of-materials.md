...
|-|-|-|-|
|Adafruit Metro M0 Express|1|Motor control logic|\~£20|
|Adafruit Feather HUZZAH (ESP8266)|1|WiFi + web server|\~£15|
|DollaTek TB6612FNG dual motor driver|1|2.5–13.5V motor supply, 2.7–5.5V logic|\~£3–5|
|TT DC gear motor|2|\~71×20×22mm, 6V rated, runs fine at 3–4V|\~£3|
|Adafruit Verter|1|Buck-boost, regulates logic supply to 5.2V|\~£8|
...
* Adafruit Perma-Proto half-size breadboard - originally used for connections, later soldered wires together and removed the breadboard
